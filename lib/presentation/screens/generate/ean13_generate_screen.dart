...
class Ean13GenerateScreen extends StatefulWidget {
  final GeneratedModel? data;
  const Ean13GenerateScreen({super.key, required this.data});

  @override
  State<Ean13GenerateScreen> createState() => _Ean13GenerateScreenState();
}

class _Ean13GenerateScreenState extends State<Ean13GenerateScreen> {
  ...
  Future<void> _handleSubmit() async {
    ...
    final generatedCode = GeneratedModel(
      ...
      barcodeType: widget.data?.barcodeType ?? 'ean13',
    );
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder:
            (_) =>
                Ean13ResultScreen(textData: content, isFromHistoryList: false),
      ),
    );
  }
