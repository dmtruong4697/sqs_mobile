...
class Ean8ResultScreen extends StatefulWidget {
  final String textData;
  final GeneratedModel? data;
  final bool isFromHistoryList;
  const Ean8ResultScreen({
    super.key,
  ...
  @override
  State<Ean8ResultScreen> createState() => _Ean8ResultScreenState();
}

class _Ean8ResultScreenState extends State<Ean8ResultScreen> {
    ...
    if (widget.isFromHistoryList) {
      ...
      Future.microtask(() {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => Ean8GenerateScreen(data: widget.data),
          ),
        );
      });
    } else {
