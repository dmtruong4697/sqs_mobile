...
class Ean13ResultScreen extends StatefulWidget {
  final String textData;
  final GeneratedModel? data;
  final bool isFromHistoryList;
  const Ean13ResultScreen({
    super.key,
  ...
  @override
  State<Ean13ResultScreen> createState() => _Ean13ResultScreenState();
}

class _Ean13ResultScreenState extends State<Ean13ResultScreen> {
    ...
    if (widget.isFromHistoryList) {
      ...
      Future.microtask(() {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => Ean13GenerateScreen(data: widget.data),
          ),
        );
      });
    } else {
