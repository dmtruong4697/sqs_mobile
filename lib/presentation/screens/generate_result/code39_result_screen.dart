...
class Code39ResultScreen extends StatefulWidget {
  final String textData;
  final GeneratedModel? data;
  final bool isFromHistoryList;
  const Code39ResultScreen({
    super.key,
  ...
  @override
  State<Code39ResultScreen> createState() => _Code39ResultScreenState();
}

class _Code39ResultScreenState extends State<Code39ResultScreen> {
    ...
    if (widget.isFromHistoryList) {
      ...
      Future.microtask(() {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => Code39GenerateScreen(data: widget.data),
          ),
        );
      });
    } else {
