...
class Code128ResultScreen extends StatefulWidget {
  final String textData;
  final GeneratedModel? data;
  final bool isFromHistoryList;
  const Code128ResultScreen({
    super.key,
  ...
  @override
  State<Code128ResultScreen> createState() => _Code128ResultScreenState();
}

class _Code128ResultScreenState extends State<Code128ResultScreen> {
  ...
  Future<void> _showBarcodeShare() async {
    try {
      ...
      await Share.shareXFiles([
        XFile(file.path),
      ], text: "Here is your Barcode!");
    } catch (e) {
      print("Error while sharing Barcode: $e");
    }
  }
    ...
    if (widget.isFromHistoryList) {
      ...
      Future.microtask(() {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => Code128GenerateScreen(data: widget.data),
          ),
        );
      });
    } else {
