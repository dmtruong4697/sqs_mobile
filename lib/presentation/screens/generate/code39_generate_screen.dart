...
class Code39GenerateScreen extends StatefulWidget {
  final GeneratedModel? data;
  const Code39GenerateScreen({super.key, required this.data});

  @override
  State<Code39GenerateScreen> createState() => _Code39GenerateScreenState();
}

class _Code39GenerateScreenState extends State<Code39GenerateScreen> {
  ...
  Future<void> _handleSubmit() async {
    ...
    final generatedCode = GeneratedModel(
      ...
      barcodeType: widget.data?.barcodeType ?? 'code39',
    );
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder:
            (_) =>
                Code39ResultScreen(textData: content, isFromHistoryList: false),
      ),
    );
  }
