...
class UrlScanResultScreen extends StatefulWidget {
  final ScannedModel scanData;

  const UrlScanResultScreen({super.key, required this.scanData});

  @override
  State<UrlScanResultScreen> createState() => _UrlScanResultScreenState();
}

class _UrlScanResultScreenState extends State<UrlScanResultScreen> {
            ...
            Column(
              ...
              children: [
                    ...
                    onPressed: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder:
                              (context) =>
                                  WebViewScreen(url: widget.scanData.content),
                        ),
                      );
                    },
                    icon: const Icon(
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: () {
                      _launchInBrowser(widget.scanData.content);
                    },
                    icon: const Icon(
                      Icons.public,
                      size: 20,
