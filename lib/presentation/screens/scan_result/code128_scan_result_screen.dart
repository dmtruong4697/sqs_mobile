...
class Code128ScanResultScreen extends StatefulWidget {
  final ScannedModel scanData;

  const Code128ScanResultScreen({super.key, required this.scanData});

  @override
  State<Code128ScanResultScreen> createState() =>
      _Code128ScanResultScreenState();
}

class _Code128ScanResultScreenState extends State<Code128ScanResultScreen> {
